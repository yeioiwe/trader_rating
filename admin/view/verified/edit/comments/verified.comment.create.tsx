...
import { getVerifiedGetCommentListQueryKey, useVerifiedCommentCreate } from '@/config/api/verified/verified';
...
export const VerifiedEditCommentCreate = ({ id }: { id: number }) => {
    const { register, getValues } = useForm();
    const { mutate } = useVerifiedCommentCreate();
