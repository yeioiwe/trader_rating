...
export const ScammerProjectsList = () => {
    const [sort, setSort] = useState<ScammersSortType>(sortParams[0]);
...
//demo sort types
export interface ScammersSortType {
    id: number;
    name: string;
}

export const sortParams: ScammersSortType[] = [
