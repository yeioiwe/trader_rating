...
export const VerifiedProfileOverview = ({ id }: { id: string }) => {
    ...
    return (
        <Col gap={2}>
            <Col width={'100%'} border={'3px solid #3BB974'} gap={1} p={2.25} borderRadius={'9px'}>
            ...
            <VerifiedProfileLike like={profile.profileLikes} watch={profile.profileViews} />
        </Col>
    );
};

const VerifiedProfileLike = ({ like, watch }: { like: number; watch: number }) => {
    return (
