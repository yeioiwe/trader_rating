...
import { sortParams, VerifiedSortType } from './verified.projects.list';

export const VerifiedListTypeSort = ({
    sort,
    setSort,
}: {
    sort: VerifiedSortType;
    setSort: Dispatch<SetStateAction<VerifiedSortType>>;
}) => {
